...
`,stats:t.html.stats,settings:t.html.settings,about:t.html.about,edit:t.html.edit}}}const v=[{name:"Modern",imagePath:"/practice/assets/layouts/modern.jpg",layoutDataGetter:p},{name:"Chroma Key",imagePath:"/practice/assets/layouts/chromaKey.jpg",layoutDataGetter:b}];function T(t){for(const e of v)if(e.name==t)return e;return v[0]}function y(){return v}function E(t){const e=()=>{let i=0;for(const n of t.children)i+=n.offsetHeight;t.style.setProperty("--total-height",`${i}px`),t.classList.remove("collapsed")};t.addEventListener("mouseenter",e),t.addEventListener("resize",e),t.addEventListener("mouseleave",()=>{t.classList.add("collapsed")}),t.addEventListener("touchend",i=>{!t.classList.contains("collapsed")||window.getComputedStyle(t).getPropertyValue("--horizontal-nav")||(i.preventDefault(),e())}),document.addEventListener("click",i=>{i.target&&!t.contains(i.target)&&t.classList.add("collapsed")})}export{h as C,d as D,T as a,S as b,m as g,E as r,L as s,M as u};
